...
public class CustomEpubSettingPanel extends PopupWindow{
    ...
    public void openSettingPopup() {
        ...
        mParentContainer = popupView.findViewById(com.hurix.epubreader.R.id.parent);
        ...
        popupWindow.setOnDismissListener(new OnDismissListener() {
            @Override
            public void onDismiss() {
                mListener.onEpubPanelPopupDismiss();
            }
        });
    }
    ...
    public void setListener(AddEubPanelDismissListener listener) {
