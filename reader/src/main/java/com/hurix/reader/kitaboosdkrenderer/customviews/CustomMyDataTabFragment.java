...
public class CustomMyDataTabFragment extends BottomSheetDialogFragment implements CustomMyDataLayout.CustomMydataLayoutCallback {
     ...
     * @return
     */
    public static CustomMyDataTabFragment newInstance(String tool, View anchor, boolean ismobile) {
        mAnchor = anchor;
        isMobile = ismobile;
        CustomMyDataTabFragment fragmentFirst = new CustomMyDataTabFragment();
    ...
    public void setupDialog(Dialog dialog, int style) {
        ...
        contentView = View.inflate(getContext(), R.layout.custom_mydata_main_screen, null);
   ...
   /* public void setParams(int width, int height, int gravity) {
    ...
    public void buildViewForSharingSetting(View view) {
        //view.setBackground(getResources().getDrawable(R.drawable.my_data_tab_exapand_background));
