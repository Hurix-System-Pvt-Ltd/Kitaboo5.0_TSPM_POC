...
public class CustomMyDataLayout extends LinearLayout implements IDestroyable, View.OnClickListener,
    ...
    //user controls
    private ListView mLstugclistdata, mLstNewNoteShare;
    private TextView mTxtmessage, mTitle, mShareSettings;
    //tmp view
    private View mView, mMydataview, mSharedwithmeview, mUnderline;
    ...
    private TextView mTextFilter, mTextNotification;
    ...
    public CustomMyDataLayout(Context context, boolean isMobile, ReaderThemeSettingVo themeUserSettingVo, int enableShareSetting) {
       ...
       // mView.setBackgroundColor(Color.TRANSPARENT);
        ...
        mTabHost = (TabHost) mView.findViewById(R.id.ugctab);
      //  mTabHost.setBackgroundColor(Color.WHITE);
       // middlecontainer.setBackgroundColor((Color.parseColor(readerThemeSettingVo.getReader().getDayMode().getMyData().getPopupBackground())));
        ...
        mLstNewNoteShare = (ListView) mView.findViewById(R.id.lstNoteshareAcceptReject);
        mLstNewNoteShare.setOnItemClickListener(this);
        // mLstNewNoteShare.setEmptyView(mView.findViewById(R.id.empty_view));
        mTxtmessage = (TextView) mView.findViewById(R.id.txtmessage);
        ...
        mProgDataLaoding = (ProgressBar) mView.findViewById(R.id.progLoading);
    ...
    private void initTabView(boolean isMobile) {
        ...
        mMydataview.setBackgroundColor(Color.WHITE);
        ...
        mSharedwithmeview.setBackgroundColor(Color.WHITE);
 ...
 //       mParentTabLayout.setBackgroundColor(Color.RED);
    ...
    public void enableSetting(int visibility) {
        ...
        if (mIsMobile) {
            mView.findViewById(R.id.toolbar).setVisibility(visibility);
        }
        mView.findViewById(R.id.shareSettinglayout).setVisibility(visibility);
    }
    ...
    private void setUpIconFonts() {
        ...
        mTitle.setTextColor(Color.parseColor(readerThemeSettingVo.getReader().getDayMode().getMyData().getIconColor()));
    ...
    private void setNoteEmptyView(String iconText, String firstline, String secondline, String thirdline) {
        TextView bookmarkIcon = (TextView) mView.findViewById(R.id.hint_icon);
        TextView bookmarkHintText = (TextView) mView.findViewById(R.id.first_hint_text);
        TextView bookmarkhintmiddleText = (TextView) mView.findViewById(R.id.second_hint_text);
        TextView hintThirdText = (TextView) mView.findViewById(R.id.third_hint_text);
    ...
    private void setEmptyView(String iconText, String firstline, String secondline, String thirdline) {
        TextView bookmarkIcon = (TextView) mView.findViewById(R.id.book_mark_hint_icon);
        TextView bookmarkHintText = (TextView) mView.findViewById(R.id.book_mark_hint_text);
        TextView bookmarkhintmiddleText = (TextView) mView.findViewById(R.id.book_mark_hint_middle_text);
    ...
    public String getDisplayFormatOfDate(String input) {
        ...
        try {
            ...
            dispFormatDate = outputFormat.format(temp).toString();
