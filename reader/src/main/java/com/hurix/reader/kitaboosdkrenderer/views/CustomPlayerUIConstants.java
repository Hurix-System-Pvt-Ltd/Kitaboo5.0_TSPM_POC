...
public class CustomPlayerUIConstants {
    ...
    public static int PT_COLOR_IC_SELECTED_FC = 0XFFFFF071;
    public static int PT_COLOR_IC_UNSELECTED_FC = 0XFFFFFFFF;
    public static int PT_COLOR_IC_SELECTED_BGC = 0XFF000000;
    public static int PT_COLOR_IC_UNSELECTED_BGC = 0X00000000;
    ...
    public static String READ_AUDIO_EPUB = "ᾅ" ;
    ...
    public static String SPEED_INC = "H" ;
    public static String SPEED_DEC = "G" ;

    // <!-- Audio Sync Color-->
    public static String AS_UNSELECTED_COLOR = "\"" ;
    public static String AS_SELECTED_COLOR = "Ź" ;
    public static String AS_COLOR_PICKER = "»" ;
