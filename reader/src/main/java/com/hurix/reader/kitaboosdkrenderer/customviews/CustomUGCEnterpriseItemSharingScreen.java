        ...
        if (mSharingData != null) {
          ...
          /*  mTxttitle.setTextColor(Color.parseColor(UserController.getInstance(mContext)
            ...
            if (!mSharingData.getNoteData().equals("")) {
                ...
                mChapterName.setText(getResources().getString(R.string.ugc_mydata_chapter_label)
                        + " " + mSharingData.getChapterName());
                mTxtdate.setText(mContext.getResources().getString(R.string.ugc_mydata_page_label) +
                        " " + vo.getFolioID() + "  " + Utils.getDateInLocalFormat(
