...
public class MobileNoteFilterDialog extends DialogFragment implements View.OnClickListener {
    ...
    public void onClick(View v) {
        if(getResources().getBoolean(R.bool.is_Oup_client) && !(mCheckShare.getVisibility() == View.VISIBLE))
        {
        ...
        if (v == mCheckAll) {
            ...
            if (mCheckAll.isChecked()) {
                ...
                if(mContext.getResources().getBoolean(R.bool.is_Navneet_Client)){
                    mListOfStickyNote.add(getResources().getString(R.string.nv_note_yellow_color));
                    mListOfStickyNote.add(getResources().getString(R.string.nv_note_red_color));
                    mListOfStickyNote.add(getResources().getString(R.string.nv_note_voilet_color));
                    mListOfStickyNote.add(getResources().getString(R.string.nv_note_green_color));
                    mListOfStickyNote.add(getResources().getString(R.string.nv_note_blue_color));
                }else{
                ...
                if(mContext.getResources().getBoolean(R.bool.is_Navneet_Client)){
                    mListOfContextNote.add(getResources().getString(R.string.nv_note_yellow_color));
                    mListOfContextNote.add(getResources().getString(R.string.nv_note_red_color));
                    mListOfContextNote.add(getResources().getString(R.string.nv_note_voilet_color));
                    mListOfContextNote.add(getResources().getString(R.string.nv_note_green_color));
                    mListOfContextNote.add(getResources().getString(R.string.nv_note_blue_color));
                } else{
        ...
        if (v == mCheckYellow) {
            if (mCheckYellow.isChecked()) {
                ...
                if (mTextNotesClciked) {
                    ...
                    if(mContext.getResources().getBoolean(R.bool.is_Navneet_Client))
                        mListOfStickyNote.remove(getResources().getString(R.string.nv_note_yellow_color));
                    else
                ...
                if (mTextContextNotesClicked) {
                    ...
                    if(mContext.getResources().getBoolean(R.bool.is_Navneet_Client))
                        mListOfContextNote.remove(getResources().getString(R.string.nv_note_yellow_color));
                    else
        ...
        if (v == mCheckRed) {
            if (mCheckRed.isChecked()) {
                ...
                if (mTextNotesClciked) {
                    ...
                    if(mContext.getResources().getBoolean(R.bool.is_Navneet_Client))
                        mListOfStickyNote.remove(getResources().getString(R.string.nv_note_red_color));
                    else
                ...
                if (mTextContextNotesClicked) {
                    ...
                    if(mContext.getResources().getBoolean(R.bool.is_Navneet_Client))
                        mListOfContextNote.remove(getResources().getString(R.string.nv_note_red_color));
                    else
        ...
        if (v == mCheckBlue) {
            if (mCheckBlue.isChecked()) {
                ...
                if (mTextNotesClciked) {
                    ...
                    if(mContext.getResources().getBoolean(R.bool.is_Navneet_Client))
                        mListOfStickyNote.remove(getResources().getString(R.string.nv_note_blue_color));
                    else
                ...
                if (mTextContextNotesClicked) {
                    ...
                    if(mContext.getResources().getBoolean(R.bool.is_Navneet_Client))
                        mListOfContextNote.remove(getResources().getString(R.string.nv_note_blue_color));
                    else
        ...
        if (mCheckYellow.isChecked() && mCheckRed.isChecked() && mCheckGreen.isChecked()
                && mCheckPurple.isChecked() && mCheckBlue.isChecked()) {
            if (mTextContextNotesClicked) {
        ...
        }else if (mCheckYellow.isChecked() && mCheckRed.isChecked() && mCheckGreen.isChecked()
        ...
        for (int i = 0; list.size() > i; i++) {
            if (list.get(i).equalsIgnoreCase("All")) {
                ...
                mCheckShare.setChecked(true);
                    ...
                    list.get(i).equalsIgnoreCase("#F00004") ||
                    list.get(i).equalsIgnoreCase("#FF7061") ||
                    list.get(i).equalsIgnoreCase(getResources().getString(R.string.note_red_color)) ||
                    list.get(i).equalsIgnoreCase(getResources().getString(R.string.note_pink_color)) ||
                    list.get(i).equalsIgnoreCase(getResources().getString(R.string.nv_note_red_color))) {
                mCheckRed.setChecked(true);
            } else if (list.get(i).equalsIgnoreCase("#F4D631")||
                    list.get(i).equalsIgnoreCase(getResources().getString(R.string.note_yellow_color)) ||
                    list.get(i).equalsIgnoreCase(getResources().getString(R.string.note_orange_color)) ||
                    list.get(i).equalsIgnoreCase(getResources().getString(R.string.nv_note_yellow_color))) {
                mCheckYellow.setChecked(true);
            } else if (list.get(i).equalsIgnoreCase("#8E44AD")||
                    list.get(i).equalsIgnoreCase(getResources().getString(R.string.note_purple_color)) ||
                    list.get(i).equalsIgnoreCase(getResources().getString(R.string.note_new_purple_color)) ||
                    list.get(i).equalsIgnoreCase(getResources().getString(R.string.nv_note_voilet_color))) {
                mCheckPurple.setChecked(true);
            } else if (list.get(i).equalsIgnoreCase("#99cc00")||
                    list.get(i).equalsIgnoreCase(getResources().getString(R.string.note_lightgreen_color)) ||
                    list.get(i).equalsIgnoreCase(getResources().getString(R.string.note_green_color)) ||
                    list.get(i).equalsIgnoreCase(getResources().getString(R.string.nv_note_green_color))) {
                mCheckGreen.setChecked(true);
            } else if (list.get(i).equalsIgnoreCase("#33E5B5")||
                    list.get(i).equalsIgnoreCase(getResources().getString(R.string.note_skyblue_color)) ||
                    list.get(i).equalsIgnoreCase(getResources().getString(R.string.note_blue_color))||
                    list.get(i).equalsIgnoreCase(getResources().getString(R.string.nv_note_blue_color))) {
    ...
    private void initView(View view) {
        ...
        if(SDKManager.getInstance().getReaderType().toString().equalsIgnoreCase("EPUB")) {
            mCheckAll.setVisibility(View.GONE);
            mCheckNotes.setVisibility(View.GONE);
            ...
            mCheckContextNotes.setLayoutParams(params);
        }
        ...
        if(mContext.getResources().getBoolean(R.bool.is_Navneet_Client)){
            mCheckRed.setTextColor(Color.parseColor(getResources().getString(R.string.nv_note_red_color)));
            mCheckYellow.setTextColor(Color.parseColor(getResources().getString(R.string.nv_note_yellow_color)));
            mCheckPurple.setTextColor(Color.parseColor(getResources().getString(R.string.nv_note_voilet_color)));
            mCheckGreen.setTextColor(Color.parseColor(getResources().getString(R.string.nv_note_green_color)));
            mCheckBlue.setTextColor(Color.parseColor(getResources().getString(R.string.nv_note_blue_color)));
        } else{
        ...
        if(getResources().getBoolean(R.bool.is_ACEP_client) || getResources().getBoolean(R.bool.is_AAO)||getResources().getBoolean(R.bool.is_TDEE)){
