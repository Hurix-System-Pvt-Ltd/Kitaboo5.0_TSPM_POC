...
public class EPUBFIXEDThumbnailAdapter extends RecyclerView.Adapter<EPUBFIXEDThumbnailAdapter.ThumbnailHolder> {
    ...
    public EPUBFIXEDThumbnailAdapter(Context context, ReaderThemeSettingVo mReaderThemeSettingVo, OnThumbnailClickListener thumbnailClickListener, SeekBarPositionChangeListner seekBarPositionChangeListner) {
        ...
        if (SDKManager.getInstance().getBookCreator().equalsIgnoreCase("kitaboo")) {
            ...
            thumbnailFolderPath = SDKManager.getInstance().getNewEPubFixedBaseUrl() + context.getString(R.string.epub_fixed_thumbnail_path) + File.separator;
        }
    ...
    public void onBindViewHolder(ThumbnailHolder holder, int position) {
        ...
        String fileNamePath = (SDKManager.getInstance().getBookCreator().equalsIgnoreCase("kitaboo")) ?
                thumbListVOArrayList.get(position).getValue() : thumbListVOArrayList.get(position).getText();

        String path = thumbnailFolderPath + fileNamePath + ".png";
