...
public class MobileHighlightFilterDialog extends DialogFragment implements View.OnClickListener {
    ...
    public void onClick(View v) {
        ...
        if (mCheckPurple.isChecked() && mCheckYellow.isChecked() && mCheckRed.isChecked()
                && mCheckBlue.isChecked() && mCheckGreen.isChecked()) {
            mCheckAll.setChecked(true);
        } else if (mCheckPurple.isChecked() && mCheckYellow.isChecked() && mCheckRed.isChecked()
            ...
            if (mCheckAll.isChecked()) {
                ...
                if (mCheckBlue.isChecked()) {
                    ...
                    if(mContext.getResources().getBoolean(R.bool.is_Navneet_Client))
                        mSelectedColorList.add(getResources().getString(R.string.nv_note_blue_color));
                    else
                ...
                if (mCheckGreen.isChecked()) {
                    ...
                    if(mContext.getResources().getBoolean(R.bool.is_Navneet_Client))
                        mSelectedColorList.add(getResources().getString(R.string.nv_note_green_color));
                    else
                ...
                if (mCheckRed.isChecked()) {
                    ...
                    if(mContext.getResources().getBoolean(R.bool.is_Navneet_Client))
                        mSelectedColorList.add(getResources().getString(R.string.nv_note_red_color));
                    else
                ...
                if (mCheckYellow.isChecked()) {
                    ...
                    if(mContext.getResources().getBoolean(R.bool.is_Navneet_Client))
                        mSelectedColorList.add(getResources().getString(R.string.nv_note_yellow_color));
                    else
                ...
                if (mCheckPurple.isChecked()) {
                    ...
                    if(mContext.getResources().getBoolean(R.bool.is_Navneet_Client))
                        mSelectedColorList.add(getResources().getString(R.string.nv_note_voilet_color));
                    else
        ...
        for (int i = 0; currentSelectedCheckBox.size() > i; i++) {
            if (currentSelectedCheckBox.get(i).equalsIgnoreCase("All")) {
                ...
                mCheckShare.setChecked(true);
                    ...
                    currentSelectedCheckBox.get(i).equalsIgnoreCase(getResources().getString(R.string.nv_note_red_color))) {
                mCheckRed.setChecked(true);
                    ...
                    currentSelectedCheckBox.get(i).equalsIgnoreCase(getResources().getString(R.string.nv_note_yellow_color))) {
                mCheckYellow.setChecked(true);
                    ...
                    currentSelectedCheckBox.get(i).equalsIgnoreCase(getResources().getString(R.string.nv_note_voilet_color))) {
                mCheckPurple.setChecked(true);
                    ...
                    currentSelectedCheckBox.get(i).equalsIgnoreCase(getResources().getString(R.string.nv_note_green_color))) {
                mCheckGreen.setChecked(true);
                    ...
                    currentSelectedCheckBox.get(i).equalsIgnoreCase(getResources().getString(R.string.nv_note_blue_color))) {
