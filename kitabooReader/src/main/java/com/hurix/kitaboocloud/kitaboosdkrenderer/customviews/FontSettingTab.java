...
public class FontSettingTab extends FrameLayout implements View.OnClickListener {
    ...
    private ArrayList<String> fontMapItems=new ArrayList<>();
    ...
    private void addFontsItems() {
        fontMapItems.add("");
        fontMapItems.add("sans");
        fontMapItems.add("georgia");
        fontMapItems.add("noto");
    }
    ...
    private void fontsInitView(View view) {
        ...
        String pageFontFamily = com.hurix.commons.utils.Utils.getSharedPreferenceStringValue(mContext, PrefActivity.SETTING_PANEL_PREF_NAME, keyFontFamily, getResources().getString(R.string.default_string));
                    ...
                    public void onItemSelected(AdapterView<?> parentView,
                        ...
                        try {
                            ...
                            if (epubSettingPanelListner != null)
                                epubSettingPanelListner.setPageFontFamily(fontMapItems.get(position));
                        }
                        catch (Exception e) {
    ...
    public void onClick(View v) {
        ...
        if (v == mTextLeftAlign) {
          ...
          //  drawActiveTextBackground(mTextLeftAlign);
            ...
            selectValue(fontSpinner,getResources().getString(R.string.default_string));
        }
    ...
    private void selectValue(Spinner spinner, String value) {
        String font=getResources().getString(R.string.default_string);
