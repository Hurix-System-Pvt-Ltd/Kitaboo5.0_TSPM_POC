...
public class CustomMobileBackEnabledActivity extends FragmentActivity implements CustomThumbnailsListner {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
       ...
       // getWindow().setFlags(WindowManager.LayoutParams.FLAG_SECURE, WindowManager.LayoutParams.FLAG_SECURE);
        com.hurix.epubreader.Utility.Utils.setSecureWindowFlags(CustomMobileBackEnabledActivity.this);
       ...
       // readerThemeSettingVo = (ReaderThemeSettingVo) getIntent().getSerializableExtra("themedata");
        readerThemeSettingVo = InsightReaderThemeController.getInstance(getApplicationContext()).getReaderThemeUserSettingVo();
