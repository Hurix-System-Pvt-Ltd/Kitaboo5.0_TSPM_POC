            ...
            if (mListofdata.get(position) != null) {
                ...
                if (txtvo.getNoteData() != null) {
                    if (txtvo.getNoteData().equals("")) {
                        ...
                        holder.chapterName.setText(mContext.getResources().getString(R.string.ugc_mydata_chapter_label) + txtvo.getChapterName().trim());

                        if(Utility.isDeviceTypeMobile(mContext)){
                            if (isEditEnabled) {
                                String datestring = getDateInLocalFormat(
                                ...
                                if (userVo != null) {
                                    holder.txtdate.setText(mContext.getResources().getString(R.string.
                                            ...
                                            + " " + userVo.getLastName() + " " +
                                            getDateInLocalFormat(txtvo.getDateTime(), "hh:mm a dd MMM yyyy"));
                                } else {
                        ...
                        if(Utility.isDeviceTypeMobile(mContext)){
                            if (isEditEnabled) {
                                ...
                                if (userVo != null) {
                                    holder.txtdate.setText(mContext.getResources().getString(R.string.
                                            ugc_mydata_shared_by_label) + " " + userVo.getFirstName() +
                                            " " + userVo.getLastName() + " " + getDateInLocalFormat(txtvo.getDateTime(), "hh:mm a dd MMM yyyy"));
                                } else {
                                    holder.txtdate.setText(getDateInLocalFormat
                                            (txtvo.getDateTime(), "hh:mm a dd MMM yyyy"));
                                }
                                holder.txttitle.setText(txtvo.getHighlightedText());
                        ...
                        holder.tvCommentsIcon.setTextColor(Color.parseColor(PlayerController.getInstance(mContext).getReader_default_panel_actions()));
                        holder.tvComments.setTextColor(Color.parseColor(PlayerController.getInstance(mContext).getReader_default_panel_actions()));
                        ...
                        holder.tvShareIcon.setTextColor(Color.parseColor(PlayerController.getInstance(mContext).getReader_default_panel_actions()));
                        holder.tvShare.setTextColor(Color.parseColor(PlayerController.getInstance(mContext).getReader_default_panel_actions()));
                        if(txtvo.getUserShareColl().size() == 0)
                        {
