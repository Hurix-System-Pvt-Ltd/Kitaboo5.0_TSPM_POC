...
public class AudioMediaPlayer extends Activity implements AVPlayerlistner, View.OnClickListener {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
     ...
     //   getWindow().setFlags(WindowManager.LayoutParams.FLAG_SECURE, WindowManager.LayoutParams.FLAG_SECURE);
        com.hurix.epubreader.Utility.Utils.setSecureWindowFlags(AudioMediaPlayer.this);
        ...
        if (getResources().getBoolean(R.bool.is_multi_lang_support)) {
            setLocale(com.hurix.kitaboo.constants.utils.Utils.getSharedPreferenceStringValue(
                    AudioMediaPlayer.this, com.hurix.kitaboo.constants.Constants.SHELF_PREFS_NAME, com.hurix.kitaboo.constants.Constants.DEFAULT_APP_LANGUAGE, ""));
        }
