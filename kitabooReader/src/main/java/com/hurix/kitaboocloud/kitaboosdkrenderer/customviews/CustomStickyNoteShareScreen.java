...
public class CustomStickyNoteShareScreen extends RelativeLayout implements OnClickListener,
    ...
    private void setthemeColor() {
        mNoUserInGroup.setTextColor(Color.parseColor(mReaderThemeSettingVo.
    ...
    public ArrayList<ListItemUserDAO> prepareLists(UserClassVO userClassVO) {
        ...
        if (studentList.size() > 0) {
            if(getResources().getBoolean(R.bool.is_Academic_Approach)){
                if(RoleName.equalsIgnoreCase(STUDENT) && userClassVO.isNoteStudentStudentSharing()){
                ...
                if (RoleName.equalsIgnoreCase(TEACHER) && userClassVO.isNoteTeacherStudentSharing() ||
                        RoleName.equalsIgnoreCase(STUDENT) && userClassVO.isNoteStudentStudentSharing()) {
