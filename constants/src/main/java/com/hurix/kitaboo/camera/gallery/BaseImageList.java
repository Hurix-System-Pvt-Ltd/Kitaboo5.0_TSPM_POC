...
package com.hurix.kitaboo.camera.gallery;
...
import com.hurix.kitaboo.camera.CameraUtil;
import com.hurix.kitaboo.camera.ImageManager;
...
public abstract class BaseImageList implements IImageList {
    ...
    private boolean isChildImageUri(Uri uri) {
        ...
        Uri base = mBaseUri;
        return CameraUtil.equals(base.getScheme(), uri.getScheme())
                && CameraUtil.equals(base.getHost(), uri.getHost())
                && CameraUtil.equals(base.getAuthority(), uri.getAuthority())
                && CameraUtil.equals(base.getPath(), getPathWithoutId(uri));
    }
