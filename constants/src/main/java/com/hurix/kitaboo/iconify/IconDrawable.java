...
import static com.hurix.kitaboo.iconify.Utils.convertDpToPx;
import static com.hurix.kitaboo.iconify.Utils.isEnabled;
...
public class IconDrawable extends Drawable {
	 ...
	 */
	public IconDrawable(Context context, String icon,String ttfFile) {
		this.context = context;
		this.icon = icon;
		paint = new TextPaint();
		paint.setTypeface(Iconify.getTypeface(context, ttfFile));
